    ...
    <div class="row" style="margin: 0;">
        <div class="col-lg-6 col-md-12">
            ...
            <div class="input-group row">
                ...
                <input id="supplier" type="text" name="supplier" tabindex="3" class="signup-input   col-lg-8 col-md-9" value="<?php echo $info->Supplier  ?>">
            </div>
        ...
        <div class="col-lg-6 col-md-12">
            ...
            <div class="input-group row">
                ...
                <input id="amount" type="number" name="amount" tabindex="3" class="signup-input   col-lg-8 col-md-9" value="<?php echo $info->Amount ? $info->Amount : 0 ?>">
            </div>

            <div class="input-group row">
                <Label for="price" class="signup-label  col-lg-4 col-md-3">Giá <span class="error-star">*</span></Label>
                <input id="price" type="number" name="price" tabindex="3" class="signup-input   col-lg-8 col-md-9" value="<?php echo $info->Price ?>">
            </div>

            <div class="input-group row">
                <Label for="discount" class="signup-label  col-lg-4 col-md-3">Giảm giá (%) </Label>
                <input id="discount" type="number" name="discount" tabindex="3" class="signup-input   col-lg-8 col-md-9" value="<?php echo $info->Discount ?  $info->Discount : 0  ?>">
            </div>
        ...
        <div class="col-12">
            <div class="input-group row">
                ...
                <input id="description" type="text" name="description" tabindex="2" class="signup-input col-12" value="<?php echo $info->Description ?>">
            </div>
